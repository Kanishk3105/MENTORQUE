            ...
            <nav className="flex items-center gap-1">
              {isAdminRoute && user?.role === "ADMIN" ? (
                <>
                  ...
                  <NavLink to="/admin/recommendations" className={navLinkClass}>
                  ...
                  <NavLink to="/admin/profiles" className={navLinkClass}>
                    <span className="hidden md:inline">Profiles &amp; Tags</span>
